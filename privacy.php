<?php
/**
 * Privacy Policy | NSheth Portfolio
 */
$site = [
    'name' => 'Nityam Sheth',
    'title' => 'Privacy Policy – NSheth',
...
<head>
    ...
    <meta name="description" content="Privacy Policy for NSheth.in - How we handle your data.">
    <link rel="canonical" href="https://nsheth.in/privacy">
...
<section class="legal-page">
    <div class="container">
        <div class="legal-header">
            ...
            <p class="legal-updated">Last updated: March 21, 2023</p>
        </div>
        ...
        <div class="legal-content">
            ...
            <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to https://nsheth.in/.</li>
                ...
                <li><strong>Website</strong> refers to https://nsheth.in/, accessible from https://nsheth.in/</li>
            ...
            <ul>
                <li>By email: <a href="mailto:<?= htmlspecialchars($site['email']) ?>"><?= htmlspecialchars($site['email']) ?></a></li>
            </ul>
        </div>
    </div>
</section>
